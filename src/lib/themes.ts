...
export const themes: Theme[] = [
  {
    id: 'jcubhub',
    name: 'JCubHub',
    description: 'Indigo accent on zinc neutrals — matches the JCubHub ecosystem (default)',
    colors: {
      background: 'oklch(0.985 0.002 286)',
      foreground: 'oklch(0.21 0.006 286)',
      card: 'oklch(1 0 0)',
      cardForeground: 'oklch(0.21 0.006 286)',
      popover: 'oklch(1 0 0)',
      popoverForeground: 'oklch(0.21 0.006 286)',
      primary: 'oklch(0.51 0.23 277)',
      primaryForeground: 'oklch(0.985 0 0)',
      secondary: 'oklch(0.967 0.001 286)',
      secondaryForeground: 'oklch(0.21 0.006 286)',
      muted: 'oklch(0.967 0.001 286)',
      mutedForeground: 'oklch(0.552 0.014 286)',
      accent: 'oklch(0.58 0.20 277)',
    ...
    darkColors: {
      ...
      primaryForeground: 'oklch(0.141 0.005 286)',
      secondary: 'oklch(0.274 0.006 286)',
      secondaryForeground: 'oklch(0.985 0 0)',
      muted: 'oklch(0.274 0.006 286)',
      mutedForeground: 'oklch(0.71 0.01 286)',
      accent: 'oklch(0.68 0.16 277)',
      accentForeground: 'oklch(0.141 0.005 286)',
